...
;;;;;;;;;;;;<switch-window>
  (add-to-list 'load-path "~/my-emacs-lib/switch-window/")
...
;;;;;;;;;;;;<nyan-mode>
  (add-to-list 'load-path "~/my-emacs-lib/nyan/")
  (require 'nyan-mode)
  (nyan-mode t)
;;;;;;;;;;;;</nyan-mode>
  ...
  ;(global-set-key (kbd "<escape>") 'holy-mode)
  (global-set-key (kbd "M-m SPC") 'avy-goto-char)

  (add-hook 'prog-mode-hook #'linum-mode)

  (remove-hook 'c-mode-hook 'flycheck-mode)
  (remove-hook 'c++-mode-hook 'flycheck-mode)
  (add-to-list 'load-path "~/my-emacs-lib/lispy/")
...
;;;;;;;;;;;<cedet>
  ...
  (define-key semantic-mode-map [M-f12] 'senator-fold-tag-toggle)
  (define-key global-map [M-f11] 'sourcepair-load)
